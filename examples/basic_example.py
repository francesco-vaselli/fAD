...
def main():
    ...
    for name, model in models.items():
        ...
        precision, recall, f1, _ = precision_recall_fscore_support(y_test, scores >= 0, average='binary')
...
def visualize_results(X, y_true, model_scores):
    ...
    plt.scatter(X[y_true==0, 0], X[y_true==0, 1], c='blue', alpha=0.5, label='Normal')
    plt.scatter(X[y_true==1, 0], X[y_true==1, 1], c='red', alpha=0.5, label='Anomaly')
